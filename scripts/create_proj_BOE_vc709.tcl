set proj_name "BOE"
set root_dir [pwd]
set proj_code_dir $root_dir/../BOE
set proj_dir $root_dir/proj_$proj_name

set lib_dir $root_dir/ipRepository
set src_dir $proj_code_dir/rtl
set ip_dir $proj_code_dir/ip
set constraints_dir $proj_code_dir/constraints
...
add_files $src_dir/NIU/vc709
add_files $ip_dir/mig_axi_mm_dual.dcp
add_files $ip_dir/SmartCamCtl.dcp
add_files -fileset constrs_1 $constraints_dir/BOE.xdc
set_property top BOE [current_fileset]
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/ten_gig_eth_pcs_pma_ip/ten_gig_eth_pcs_pma_ip.xci]
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/ten_gig_eth_mac_ip/ten_gig_eth_mac_ip.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/axis_sync_fifo/axis_sync_fifo.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/cmd_fifo_xgemac_rxif/cmd_fifo_xgemac_rxif.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/cmd_fifo_xgemac_txif/cmd_fifo_xgemac_txif.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/axis_pkt_fifo/axis_pkt_fifo.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/axis_register_slice_64/axis_register_slice_64.xci]
update_compile_order -fileset sources_1

create_ip -name toe -vendor ethz.systems -library hls -version 1.6 -module_name toe_ip
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/toe_ip/toe_ip.xci]
update_compile_order -fileset sources_1

create_ip -name udp -vendor xilinx.labs -library hls -version 1.41 -module_name udp_0
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/udp_0/udp_0.xci]
update_compile_order -fileset sources_1

create_ip -name ip_handler -vendor ethz.systems -library hls -version 1.2 -module_name ip_handler_ip
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/ip_handler_ip/ip_handler_ip.xci]
update_compile_order -fileset sources_1

create_ip -name mac_ip_encode -vendor xilinx.labs -library hls -version 1.04 -module_name mac_ip_encode_ip
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/mac_ip_encode_ip/mac_ip_encode_ip.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/axis_interconnect_3to1/axis_interconnect_3to1.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/axis_interconnect_2to1/axis_interconnect_2to1.xci]
update_compile_order -fileset sources_1

create_ip -name icmp_server -vendor xilinx.labs -library hls -version 1.67 -module_name icmp_server_ip
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/icmp_server_ip/icmp_server_ip.xci]
update_compile_order -fileset sources_1

create_ip -name udpAppMux -vendor xilinx.labs -library hls -version 1.05 -module_name udpAppMux_0
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/udpAppMux_0/udpAppMux_0.xci]
update_compile_order -fileset sources_1

create_ip -name dhcp_client -vendor xilinx.labs -library hls -version 1.05 -module_name dhcp_client_0
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/dhcp_client_0/dhcp_client_0.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/echo_server_application_ip/echo_server_application_ip.xci]
update_compile_order -fileset sources_1

create_ip -name udpLoopback -vendor xilinx.labs -library hls -version 1.10 -module_name udpLoopback_0
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/udpLoopback_0/udpLoopback_0.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/axi_interconnect_ip/axi_interconnect_ip.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/axi_datamover_0/axi_datamover_0.xci]
update_compile_order -fileset sources_1
...
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/axi_datamover_1/axi_datamover_1.xci]
update_compile_order -fileset sources_1

create_ip -name arp_server_subnet -vendor ethz.systems -library hls -version 1.0 -module_name arp_server_subnet_ip
generate_target all [get_files $proj_dir/$proj_name.srcs/sources_1/ip/arp_server_subnet_ip/arp_server_subnet_ip.xci]
update_compile_order -fileset sources_1
